          ...
          <Swiper autoplay showsPagination={false}>
            ...
            >
              ...
              <View style={styles.updatesHeaderTextContainer}>
                <Text
                  style={styles.updatesHeaderText}
                >{`KNUST commence matricuation of  freshers despite the freshers number appearing quite small`}</Text>
              </View>
            </View>
            ...
            >
              ...
              >
                <Image source={News_Two} style={styles.updatesHeaderImage} />
              </View>

              <View style={styles.updatesHeaderTextContainer}>
                <Text
                  style={styles.updatesHeaderText}
                >{`UEW qualifies to the final NSMQ Stage`}</Text>
              </View>
            </View>

            <View style={styles.updatesHeaderContainer}>
              <View style={styles.updatesHeaderImageContainer}>
                <Image source={News_Three} style={styles.updatesHeaderImage} />
              </View>

              <View style={styles.updatesHeaderTextContainer}>
                <Text
                  style={styles.updatesHeaderText}
                >{`Legon SRC President donates 200 laptops to NSMQ contestants`}</Text>
              </View>
            </View>
          </Swiper>
        </View>
          ...
          <View style={styles.updatesBodyMainContainer}>
            <View style={styles.updatesBodyContainer}>
              ...
              <Text style={styles.updatesBodyText}>
                Nnulla non labore sunt. In ut commodo nostrud et ipsum elit.
                Culpa laborum duis et incididunt Lorem. Culpa laboris voluptate
                duis qui dolore eu consequat officia. Deserunt enim tempor elit
                occaecat eiusmod culpa id officia deserunt nostrud tempor id
                eiusmod ipsum.
              </Text>
            </View>
          </View>
