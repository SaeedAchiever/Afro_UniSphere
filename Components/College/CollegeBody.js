...
const CollegeBody = () => {
  ...
  const Education = colleges.filter(
    value => {return value.type == "Education"}
  )

  const Nursing = colleges.filter(
    value => {return value.type == "Nursing"}
  )

  const Agric = colleges.filter(
    value => {return value.type == "Agric"}
  )

  const Poly  = colleges.filter(
    value => {return value.type == "poly"}
  )
        ...
        <View>
                  ...
                  <View style={styles.UniHomeContainer}>
                    ...
                    <View style={{
                      ...
                      <View>
                       <Text style={styles.uniMainHomeLocText}>{`Courses ${item.length}`}</Text>
                      </View>
                    </View>
