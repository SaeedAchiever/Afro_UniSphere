      ...
      <View style={styles.schoolNoteHeadContainer}>
        ...
        <View style={styles.schoolNoteBodyBoxHeader}>
          ...
          <View>
            <Text
              style={styles.schoolNoteBodyBoxHeaderStarText}
            >{`${university.reviews} Reviews`}</Text>
          </View>
        </View>
          ...
          <View style={styles.schoolNoteBodyBoxBody}>
            ...
            <View style={styles.schoolNoteRateBox}>
              ...
              <View style={styles.schoolNoteRateLength}>
                <View
                  style={[styles.schoolNoteRateLengthTwo, { width: "100%" }]}
                ></View>
              </View>
              <View>
            ...
            <View style={styles.schoolNoteRateBox}>
              ...
              <View style={styles.schoolNoteRateLength}>
                <View
                  style={[styles.schoolNoteRateLengthTwo, { width: "80%" }]}
                ></View>
              </View>
              <Text style={styles.schoolNoteBodyBoxHeaderStarText}>-</Text>
            </View>
            ...
            <View style={styles.schoolNoteRateBox}>
              ...
              <View style={styles.schoolNoteRateLength}>
                <View
                  style={[styles.schoolNoteRateLengthTwo, { width: "60%" }]}
                ></View>
              </View>
              <Text style={styles.schoolNoteBodyBoxHeaderStarText}>-</Text>
            </View>
            ...
            <View style={styles.schoolNoteRateBox}>
              ...
              <View style={styles.schoolNoteRateLength}>
                <View
                  style={[styles.schoolNoteRateLengthTwo, { width: "40%" }]}
                ></View>
              </View>
              <Text style={styles.schoolNoteBodyBoxHeaderStarText}>-</Text>
            </View>
            ...
            <View style={styles.schoolNoteRateBox}>
              ...
              <View style={styles.schoolNoteRateLength}>
                <View
                  style={[styles.schoolNoteRateLengthTwo, { width: "20%" }]}
                ></View>
              </View>
              <Text style={styles.schoolNoteBodyBoxHeaderStarText}>-</Text>
            </View>
          ...
          <View style={styles.schoolNoteSubBoxContainer}>
            ...
            <View style={styles.schoolNoteSubMainBox}>
              ...
              <View style={{ alignItems: "center" }}>
                <Text style={styles.schoolNoteBodyBoxHeaderStarText}>
                  Placement
                </Text>
                <View
                  style={{
