    ...
    <View>
      ...
      >
        ...
        >
          ...
          <Text
            style={styles.CollegeMainLocation}
          >{`${university.region}`}</Text>
          <Text
            style={styles.CollegeMainLocation}
          >{`${university.town}, ${university.location}`}</Text>
        </View>
      </ImageBackground>
      ...
      <View style={styles.bodyContainer}>
        <View style={styles.paraContainer}>
          <View style={styles.uniHomeChildren}>
            ...
            <View style={styles.uniHomeRevContainer}>
              ...
              <View style={styles.revTextContainer}>
                <Text
                  style={styles.schoolNoteBodyText}
                >{`Based On ${university.reviews} Reviews`}</Text>
              </View>
            </View>
            ...
            <View>
              <Text
                style={styles.schoolNoteBodyText}
              >{` Since ${university.est_year}`}</Text>
            </View>
            ...
            <View>
              <Text
                style={styles.schoolNoteBodyText}
              >{`Ranked ${university.rank} of 1104 in Africa`}</Text>
            </View>

            {/* Admission */}
            <View style={styles.AdmissionStat}>
              <Text style={styles.AdmissionStatText}>
                Admissions : Forms Sales Ongoing
              </Text>
            </View>
          </View>
          ...
          <View
            style={[
              styles.uniLogoMainContainer,
              {
                width: "40%",
                maxWidth:200,
                height: width > 550 ? 200 : 120,
              },
            ]}
          >
            <Image
      ...
      <View style={styles.schoolNoteMainContainer}>
        <View style={styles.schoolNoteHeadContainer}>
          <Text
            style={styles.campusesTitle}
          >{`Welcome to ${university.nick}`}</Text>
        </View>
